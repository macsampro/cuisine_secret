...
export class PreparationStepsController {
  constructor(private readonly preparationStepsService: PreparationStepsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePreparationStepDto: UpdatePreparationStepDto) {
